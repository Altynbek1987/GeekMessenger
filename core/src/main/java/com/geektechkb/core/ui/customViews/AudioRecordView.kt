...
class AudioRecordView : FrameLayout {
    ...
    @DrawableRes
    var cancelIcon: Int = R.drawable.ic_release_locked_lock
        set(value) {
            if (value == field) return

            field = value
            binding.recordCircle.releaseLockDrawable =
                ResourcesCompat.getDrawable(resources, value, null)!!
        }
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        if (ta.hasValue(R.styleable.AudioRecordView_cancel_icon)) {
            cancelIcon = ta.getResourceId(R.styleable.AudioRecordView_cancel_icon, 0)
        }
