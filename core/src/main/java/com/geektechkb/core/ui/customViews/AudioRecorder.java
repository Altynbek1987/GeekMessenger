...
public class AudioRecorder {
                ...
                new Thread() {
                    ...
                    public void run() {
                        ...
                        if (record.getState() != AudioRecord.STATE_INITIALIZED) {
                            Log.w("gaypop", "Failed to start recording");
                            mAlive = false;
                            return;
                        }
                        ...
                        try {
                            while (isRecording()) {
                                ...
                                if (len >= 0 && len <= buffer.size) {
                                    ...
                                    Log.w("gaypop", "Unexpected length returned: " + len);
                                }
                            }
                        } catch (IOException e) {
                            Log.e("gaypop", "Exception with recording stream", e);
                        } finally {
                            stopInternal();
                            try {
                                record.stop();
                            } catch (IllegalStateException e) {
                                Log.e("gaypop", "Failed to stop AudioRecord", e);
                            }
                            record.release();
                        }
                    }
    ...
    private void stopInternal() {
        ...
        try {
            ...
            Log.e("gaypop", "Failed to close output stream", e);
        }
    }
    ...
    public void stop() {
        ...
        try {
            ...
            Log.e("gaypop", "Interrupted while joining AudioRecorder thread", e);
